...
<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="#module=/toListSmallType&type_id=${type.typeId}&_t=${newDateTime}">商城分类</a></li>
            <li><a href="javascript:void (0);">添加${type.typeName}分类</a></li>
        </ol>
        ...
        <div class="box">
            ...
            <div class="box-content">
                ...
                <form class="form-horizontal" role="form">
                    <input type="hidden" id="is_type" name="is_type" value="${type.typeId}">
...
//        }
        $.ajax({
            ...
            success: function (_data) {
                ...
                if (data.success) {
                    alert("添加小分类成功");
                    window.location.href = "#module=toAddGoodsSmallType" +"&typeId="+ is_type + "&_t=" + new Date().getTime();
                } else {
