        ...
        <div class="box">
            ...
            <div class="box-content">
                ...
                <form class="form-horizontal" role="form">
                    <input type="hidden" value="${loadPic.load_pic_id}" id="load_pic_id">

                    <div class="form-group">
                        <label class="col-sm-2 control-label">广告图片</label>

                        <div class="col-sm-10 col-md-2">
                            <img class="img-thumbnail" name="imagePath" id="imageDiv" src="${loadPic.load_pic}"
...
<script type="text/javascript">
    function saveP() {
        var load_pic_id = $("#load_pic_id").val();
        ...
        $.ajax({
            cache: true,
            type: "POST",
            url: "/loadPicController/edit.do",
            data: {
                "load_pic_id": load_pic_id,
                "load_pic": imagePath
            },
            async: false,
            success: function (_data) {
                ...
                if (data.success) {
                    alert("执行成功");
                    window.location.href = "#module=loadPicController/list"+ "&_t="+ new Date().getTime();
                } else {
                    alert("执行失败，请检查")
                }
            }
