                ...
                <form id="save_form" class="form-horizontal" method="post" role="form">
                    ...
                    <c:if test="${is_pingtai == '1'}">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" id="pv_prices" class="form-control" placeholder="PV利润"
                                       data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
                            </div>
                        </div>
                    </c:if>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <div class="toggle-switch toggle-switch-success">
                                <label>
                                    <input id="is_zhekou" name="is_zhekou" type="checkbox">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="zhekou_number" class="form-control" placeholder="只能是数字，例如8折就填写8，9.8折就填写9.8"
                                   data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="dianpu_number" class="form-control" placeholder="店铺内排序,数字越大越靠前" value="0"
                                   data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
                        </div>
                    </div>
