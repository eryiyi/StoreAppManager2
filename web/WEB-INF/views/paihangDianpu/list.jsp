...
<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="javascript:void(0)">推荐店铺列表</a></li>
        </ol>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-default btn-sm"
                                   href="#module=/paihangDianpuController/toDetail&mm_paihang_id=${e.mm_paihang_id}"
                                   role="button">管理</a>
                            </td>
...
<script type="text/javascript">
    function searchIndex(e) {
        ...
        if (_index <= ${page.pageCount} && _index >= 1) {
            window.location.href = "#module=/paihangDianpuController/list&page=1"  + "&size=" + size + "&is_del=" + is_del+ "&_t=" + new Date().getTime();
        } else {
    ...
    function nextPage(_page) {
        ...
        if ((page <= ${page.pageCount} && page >= 1)) {
            window.location.href = "#module=/paihangDianpuController/list&page=" + page + "&size=" + size + "&is_del=" + is_del+ "&_t=" + new Date().getTime();
        } else {
            alert("请输入1-${page.pageCount}的页码数");
        }
    }
