...
<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="javascript:void (0);">推荐商家排行榜</a></li>
            <li><a href="javascript:void (0);">推荐商家排行榜</a></li>
        </ol>
            ...
            <div class="box-content">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div id="mm_emp_nickname">${recordVO.company_name}</div>
                        </div>
                    </div>
...
//        }
        ...
        $.ajax({
            cache: true,
            type: "POST",
            url: "/paihangDianpuController/update.do",
            data: {
            ...
            success: function (_data) {
                ...
                if (data.success) {
                    alert("修改成功");
                    window.location.href = "#module=paihangDianpuController/list"+ "&_t=" + new Date().getTime();
                } else {
                    var _case = {1: "修改失败"};
